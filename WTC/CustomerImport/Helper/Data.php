...
namespace WTC\CustomerImport\Helper;
...
class Data extends AbstractHelper
{
     ...
     * @var string[]
     */
    protected array $allowedCSVFileTypes = ['csv']; // In Future we can add other extension format like txt
    /**
     * @var string[]
     */
    protected array $allowedJSONFileTypes = ['json']; // In Future we can add other extension format like txt
    ...
    public function getCsvFileData($fileName)
    {
        $csvData = [];
        try {
            $this->log('Fetch Data from ' . $fileName);
